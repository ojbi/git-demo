...
$cdatearray = explode('-',$cdate);
 ...
 <div class="jobformlayout">
   ...
   <img src="../images/jo.png" width="100px" height="100px"><h3>  <?php echo $pos;?></h3>
<br>

<form action="" method="POST" autocomplete="off">

        <label> Position Title:</label><input id="name" name="pos" type="text" maxlength="50" value="<?php echo $pos;?>" disabled><br>
        <label>Opening Date :</label>
            <?php
            // Months
             
              $month = array ("01"=>"January", "02"=>"February", "03"=> "March", "04"=>"April", "05"=>"May", "06"=>"June", "07"=>"July", "08"=>"August", "09"=>"September", "10"=>"October", "11"=>"November", "12"=>"December");
              $select = "<select name='omonth' disabled>\n";
              ...
              // Date
              echo " <select name='odate' disabled>";
        ...
        <label>Closing Date:</label>
            ...
            // Months
              $c_month = date("m");
              $sel_cmonth = "<select name='cmonth' disabled>\n";
              foreach ($month as $key => $val) 
              {
              ...
              // Date
              echo " <select name='cdate' disabled>";
        ...
        <textarea rows="20" cols="200" name="res" disabled><?php echo $res; ?></textarea>  <br>
        <label>  Requirements:</label><textarea rows="20" cols="200" name="req" disabled> <?php echo $req; ?></textarea>
        <br>
